# Get / Set Rx PGN Enable List F1

Manages Rx (receive) PGN enable lists using Format 1 encoding. This command allows batch configuration of multiple PGNs for reception filtering.
...
### Example - Get Rx PGN Enable List F1
...
### Example - Set Rx PGN Enable List F1
...
The device will respond with a standard BEM Response (BST A0H, BEM 48H). The response follows the standard [BEM Response](../bst-bem-response.md) format with the BEM header containing:
