...
Note: The NMEA 0183 standard is both a protocol and a data format. See the [NMEA 0183 protocol document](../../DataProtocols/nmea0183-protocol.md) for details of how NMEA 0183 frames are decoded into sentences.
...
- [2] [NMEA 0183 Protocol document](../../DataProtocols/nmea0183-protocol.md)
