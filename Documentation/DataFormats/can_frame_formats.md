...
|--------|----------------|-----------|----------------------------|----------------|-------------|
| CAN Ascii | Excellent | High | Generic terminal/log tools | Low | Quick diagnostics, ad‑hoc capture |
| $MXPGN | Moderate | Higher | NMEA 0183 aware apps | Medium | Mixed 0183 + selected PGNs streams |
| BST95 Binary | None (raw) | Low (best) | Requires custom/SDK decoder | Higher | High volume capture, cloud forward |
