...
namespace Sdk
{
	...
	*******************************************************************************/
	...
	{
		return id == BstId::Bem_GP_A0 || id == BstId::Bem_GP_A2 ||
		       id == BstId::Bem_GP_A3 || id == BstId::Bem_GP_A5;
	}
	...
	*******************************************************************************/
	...
	{
		return id == BstId::Bem_PG_A1 || id == BstId::Bem_PG_A4 ||
		       id == BstId::Bem_PG_A6 || id == BstId::Bem_PG_A8;
	}
	...
	*******************************************************************************/
	[[nodiscard]] inline std::string bstIdToString(BstId id)
	{
		...
		case BstId::Bem_GP_A5:             return "BEM Response";
		case BstId::Bem_PG_A1:
		case BstId::Bem_PG_A4:
		case BstId::Bem_PG_A6:
		case BstId::Bem_PG_A8:             return "BEM Command";
		default:                           return "Unknown BST-" + 
