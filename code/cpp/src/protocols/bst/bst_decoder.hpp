...
namespace Actisense
{
	namespace Sdk
	{
		...
		public:
			 ...
			 *******************************************************************************/
			[[nodiscard]] std::optional<Bst93Frame> decode93(ConstByteSpan data,
			...
			/**************************************************************************/ /**
			 ...
			 \return     Decoded frame or nullopt on error
			 *******************************************************************************/
			[[nodiscard]] std::optional<Bst94Frame> decode94(ConstByteSpan data,
															 std::string& outError) const;
			...
			/**************************************************************************/ /**
			 ...
			 \return     Decoded frame or nullopt on error
			 *******************************************************************************/
			[[nodiscard]] std::optional<Bst95Frame> decode95(ConstByteSpan data,
															 std::string& outError) const;
			...
			/**************************************************************************/ /**
			 ...
			 \return     Decoded frame or nullopt on error
			 *******************************************************************************/
			[[nodiscard]] std::optional<BstD0Frame> decodeD0(ConstByteSpan data,
															 std::string& outError) const;
		...
		public:
			 ...
			 *******************************************************************************/
			[[nodiscard]] bool encode94(const Bst94Frame& frame, std::vector<uint8_t>& outData,
										std::string& outError) const;
			...
			/**************************************************************************/ /**
			 ...
			 \return     True on success
			 *******************************************************************************/
			[[nodiscard]] bool encodeD0(const BstD0Frame& frame, std::vector<uint8_t>& outData,
										std::string& outError) const;
